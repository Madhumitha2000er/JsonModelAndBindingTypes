		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comtestjsonmodeldemoapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtestjsonmodeldemoapp-display": {
								"semanticObject": "comtestjsonmodeldemoapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.test.jsonmodeldemoapp",
									"url": sap.ui.require.toUrl("com/test/jsonmodeldemoapp")
								}
							}
						}
					}
